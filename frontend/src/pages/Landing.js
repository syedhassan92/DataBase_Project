  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900">
      ...
      <div className="relative z-10">
        ...
        <div className="max-w-7xl mx-auto px-6 py-16 border-t border-blue-500/20">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 text-center">
            <div className="space-y-2">
              <p className="text-4xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-cyan-400">500+</p>
              <p className="text-gray-300">Teams Managed</p>
            </div>
            <div className="space-y-2">
              <p className="text-4xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-pink-400">1000+</p>
              <p className="text-gray-300">Players Tracked</p>
            </div>
            <div className="space-y-2">
              <p className="text-4xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-orange-400 to-red-400">2000+</p>
              <p className="text-gray-300">Matches Scheduled</p>
            </div>
            <div className="space-y-2">
              <p className="text-4xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-green-400 to-emerald-400">50+</p>
              <p className="text-gray-300">Leagues Active</p>
            </div>
          </div>
        </div>
