            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                ...
                <select
                  ...
                  required
                >
                  <option value="" className="text-gray-500">Select a league</option>
                  {leagues.map(league => (
                    <option key={league.LeagueID} value={league.LeagueID} className="text-gray-900">
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 text-gray-900 bg-white"
                >
                  <option value="" className="text-gray-500">Select a coach</option>
                  {coaches.map(coach => (
                    <option key={coach.CoachID} value={coach.CoachID} className="text-gray-900">
